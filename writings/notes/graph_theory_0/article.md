...
在有向图中，各结点的出度之和等于入度之和，即：

证明任何一群人中，有偶数个人认识其中奇数个人。

试证明：在任意六个人的聚会上，要么有三个人曾相识，要么有三人不曾相识。

设有一个图有10个结点且所有结点的度都为6，求该图的边数。

在一个羽毛球比赛中，n名选手中任意两名选手之间至多比赛一次，每个选手至少比赛一次。证明：一定能找到两名选手，他们的比赛次数相同。
